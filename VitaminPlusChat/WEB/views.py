...
def keyword(request):
    ...
    for i in chatData:
        if wordList[0] in i.chat:
            chat1.append(i.liveTime +" "+ i.chat)
        if wordList[1] in i.chat:
            chat2.append(i.liveTime +" "+  i.chat)
        if wordList[2] in i.chat:
            chat3.append(i.liveTime +" "+  i.chat)
        if wordList[3] in i.chat:
            chat4.append(i.liveTime +" "+  i.chat)
        if wordList[4] in i.chat:
            chat5.append(i.liveTime +" "+  i.chat)

    return render(request, 'keyword/keyword.html', {'word': wordList, 'chat1':chat1, 'chat2':chat2, 'chat3':chat3, 'chat4':chat4, 'chat5':chat5})
